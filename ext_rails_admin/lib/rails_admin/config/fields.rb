...
module RailsAdmin
  module Config
    module Fields
      autoload :Base, 'rails_admin/config/fields/base'
      autoload :Group, 'rails_admin/config/fields/group'
      autoload :Association, 'rails_admin/config/fields/association'
